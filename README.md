...
| Web | 主题创建、候选信源发现、情报流、事件详情、已读/收藏/忽略、偏好记忆、主题时间线、简报中心（每日/每周/每月筛选）、单条/简报/批量 Markdown 导出（Obsidian-friendly 文件名）、信源治理、OWNER/ADMIN 工作区成员与近 30 天用量审计、`/api/health` |
| Worker | RSS 抓取、Item 写入、原文全文抓取、确定性+AI 情报管线、偏好归纳、每日/每周/每月简报（UTC 窗口幂等）、source quality observation、`--health` |
