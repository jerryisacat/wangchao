  ...
  return (
    <>
      ...
      <form action={updateTopicAction} className="grid gap-3">
            ...
            <Card variant="work">
              <CardHeader>
                <CardTitle><h2>基本信息</h2></CardTitle>
              </CardHeader>
              <CardContent className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    required
                    className="min-h-14 min-w-0 text-base"
                  />
                </div>
                <div className="grid gap-2">
            ...
            <Card variant="work">
              ...
              <CardContent className="grid gap-4">
                <div className="grid gap-2">
                <Label htmlFor="topicKeywords">关键词（必填，每行或逗号分隔）</Label>
                <Textarea
                  id="topicKeywords"
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicEntities">关键实体（每行或逗号分隔）</Label>
                <Textarea
                  id="topicEntities"
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicIncludeScope">应覆盖范围（每行一项）</Label>
                <Textarea
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicExcludeScope">应排除范围（每行一项）</Label>
                <Textarea
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicImportanceRules">重要性规则（每行一项）</Label>
                <Textarea
            ...
            <Card variant="work">
              ...
              <CardContent className="grid gap-4">
                <div className="grid gap-2">
                <Label htmlFor="topicSummaryLanguage">摘要语言</Label>
                <Input
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicTerminologyRules">术语规则（每行一项）</Label>
                <Textarea
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicDigestStructure">简报结构</Label>
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicDigestDetailLevel">详细程度</Label>
              ...
              <div className="grid gap-2">
                <Label htmlFor="topicDigestMaxEvents">最大事件数</Label>
                <Input
