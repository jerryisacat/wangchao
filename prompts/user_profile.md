...
- **Secondary Domain:** Aerospace Engineering (Orbital mechanics, Starship, Heavy lift launch vehicles).
- **Consumer Tech:** Only flagship/breakthrough hardware from major players (Apple, Huawei/Xiaomi/OPPO/Vivo, NVIDIA, Intel, AMD chips).
...
- **Location Focus:** Prioritize SG/CN/US tech geopolitical news. Also highly sensitive to major global/domestic breaking news (World-Changing events).
...
- **Routine Politics:** Daily elections, regular diplomatic speeches, minor trade wars, routine social policy changes (Note: Exception for Tier 1 Global Black Swan events).
- **Clickbait/Viral:** Celebrity gossip (Jeff Bezos' wife), generalized "Viral trends", minor gaming opinions, entertainment social media drama. (Note: Exception for Tier 2 Tech Giant Insider).
